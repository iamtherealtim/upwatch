...
<body>
    ...
    <div class="content">
        ...
        <h2 style="margin: 0; color: #059669; text-align: center;">Incident Resolved</h2>
        
        <div class="resolved-box">
            <h3 style="margin: 0 0 15px 0;"><?= esc($incident->title) ?></h3>
            
            <p style="margin: 15px 0; color: #059669; font-weight: 600;">
                This incident has been resolved. All affected systems are now operating normally.
            </p>
